...
/***/ 8018:
/*!***********************************************!*\
  !*** ./src/app/datepicker/datepicker.page.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DatepickerPage": () => (/* binding */ DatepickerPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _datepicker_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./datepicker.page.html?ngResource */ 2735);
/* harmony import */ var _datepicker_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./datepicker.page.scss?ngResource */ 4798);
...
let DatepickerPage = class DatepickerPage {
    constructor(modalController, DatabaseService) {
    ...
    finishInput() {
        if (this.page === 'zeitraumFrom') {
            this.DatabaseService.startDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.selectedDateTime).locale('de').format('lll');
        }
        if (this.page === 'zeitraumTo') {
            this.DatabaseService.endDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.selectedDateTime).locale('de').format('lll');
        }
        this.modalController.dismiss();
    }
};
...
DatepickerPage.propDecorators = {
    datetime: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.ViewChild, args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__.IonDatetime, { static: false },] }]
};
DatepickerPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        selector: 'app-datepicker',
        template: _datepicker_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_datepicker_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], DatepickerPage);
...
/***/ 5116:
/*!*****************************************************!*\
  !*** ./src/app/period-picker/period-picker.page.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PeriodPickerPage": () => (/* binding */ PeriodPickerPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _period_picker_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./period-picker.page.html?ngResource */ 1572);
/* harmony import */ var _period_picker_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./period-picker.page.scss?ngResource */ 8094);
...
let PeriodPickerPage = class PeriodPickerPage {
    constructor(DatabaseService, modalController) {
        this.DatabaseService = DatabaseService;
        this.modalController = modalController;
    }
    ngOnInit() {
        this.DatabaseService.startDate = moment__WEBPACK_IMPORTED_MODULE_4__().locale('de').format('lll');
        this.DatabaseService.endDate = moment__WEBPACK_IMPORTED_MODULE_4__().locale('de').format('lll');
    }
    set() {
    }
    showDatepickerFrom() {
...
PeriodPickerPage.ctorParameters = () => [
    { type: _api_database_service__WEBPACK_IMPORTED_MODULE_2__.DatabaseService },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.ModalController }
];
PeriodPickerPage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-period-picker',
        template: _period_picker_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_period_picker_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], PeriodPickerPage);
...
/* harmony export */ });
/* harmony import */ var D_David_Admin_code_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,D_David_Admin_code_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,D_David_Admin_code_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,D_David_Admin_code_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 4798:
/*!************************************************************!*\
  !*** ./src/app/datepicker/datepicker.page.scss?ngResource ***!
  \************************************************************/
/***/ ((module) => {

module.exports = "ion-content {\n  --background: #f2f2f7;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 8094:
/*!******************************************************************!*\
  !*** ./src/app/period-picker/period-picker.page.scss?ngResource ***!
  \******************************************************************/
/***/ ((module) => {

module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJwZXJpb2QtcGlja2VyLnBhZ2Uuc2NzcyJ9 */";

/***/ }),

/***/ 2735:
/*!************************************************************!*\
  !*** ./src/app/datepicker/datepicker.page.html?ngResource ***!
  \************************************************************/
/***/ ((module) => {

module.exports = "<ion-header translucent>\r\n  <ion-toolbar>\r\n    <ion-title *ngIf=\"this.page == 'zeitraumFrom'\">Beginn</ion-title>\r\n    <ion-title *ngIf=\"this.page == 'zeitraumTo'\">Ende</ion-title>\r\n    <ion-buttons slot=\"end\">\r\n      <ion-button (click)=\"dismissModal()\">abbrechen</ion-button>\r\n    </ion-buttons>\r\n  </ion-toolbar> \r\n</ion-header>\r\n\r\n<ion-content>\r\n  <div style=\"display: flex; justify-content: center;\"> \r\n    <div>\r\n      <ion-datetime\r\n      #popoverDatetime2\r\n      [locale]=\"languageCode\"\r\n      (ionChange)=\"changeDate(popoverDatetime2.value)\"\r\n      [value]=\"selectedDateTime\"\r\n      min=\"2022-10-22T00:00:00\"\r\n      >\r\n      <div slot=\"time-label\">Uhrzeit</div>\r\n    </ion-datetime>\r\n    </div>\r\n  </div>\r\n\r\n  <ion-fab horizontal=\"end\">\r\n    <ion-fab-button color=\"primary\" (click)=\"finishInput();\">\r\n      <ion-icon name=\"checkmark-outline\"></ion-icon>\r\n    </ion-fab-button>\r\n  </ion-fab>\r\n</ion-content> \r\n";

/***/ }),

/***/ 1572:
/*!******************************************************************!*\
  !*** ./src/app/period-picker/period-picker.page.html?ngResource ***!
  \******************************************************************/
/***/ ((module) => {

module.exports = "<ion-header>\r\n  <ion-toolbar>\r\n    <ion-title>Zeitraum eingeben</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content style=\"height: 250px;\">\r\n  \r\n\r\n    <ion-list>\r\n  \r\n    <ion-item (click)=\"showDatepickerFrom()\">\r\n      <ion-label position=\"stacked\">Beginn</ion-label>\r\n      <ion-input readonly>{{ this.DatabaseService.startDate }}</ion-input>\r\n    </ion-item>\r\n    \r\n    <ion-item (click)=\"showDatepickerTo()\">\r\n      <ion-label position=\"stacked\">Ende</ion-label>\r\n      <ion-input readonly>{{ this.DatabaseService.endDate }}</ion-input>\r\n    </ion-item>\r\n  \r\n    <ion-button style=\"margin: 5% 10%;\" color=\"primary\" (click)=\"set()\" expand=\"block\">Speichern</ion-button>\r\n  \r\n    </ion-list>\r\n  \r\n  \r\n\r\n</ion-content>\r\n";
